...
onready var Intro = get_node("/root/Game/Intro")
onready var EndBad = get_node("/root/Game/EndBad")
onready var EndGood = get_node("/root/Game/EndGood")
onready var ToWall = get_node("/root/Game/ToWall")
onready var ToTile = get_node("/root/Game/ToTile")
onready var ToPaddle = get_node("/root/Game/ToPaddle")
